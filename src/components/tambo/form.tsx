...
export interface FormProps
  ...
  fields: FormField[];
  /** Callback function called when the form is submitted (optional) */
...
/**
 * Zod schema for form component props validation
 */
export const formSchema = z.object({
  fields: z
    .array(
      z.object({
        ...
        sliderMin: z.number().optional().describe("Minimum value for slider"),
        sliderMax: z.number().optional().describe("Maximum value for slider"),
        sliderStep: z.number().optional().describe("Step value for slider"),
        sliderDefault: z
          .number()
          .optional()
          .describe("Default value for slider"),
        sliderLabels: z
          .array(z.string())
          .optional()
  ...
  submitText: z
    .string()
    .optional()
    .describe("Text to display on submit button (default: Submit)"),
  variant: z
...
export const FormComponent = React.forwardRef<HTMLFormElement, FormProps>(
  (
    ...
    const handleSubmit = (e: React.FormEvent) => {
      ...
      // Call onSubmit callback if provided, otherwise log the data
      if (onSubmit) {
        onSubmit(data);
      } else {
