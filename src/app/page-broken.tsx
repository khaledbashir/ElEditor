...
import { ResizablePanel } from "@/components/message-thread-panel";
        ...
        >
          <TamboMcpProvider mcpServers={mcpServers}>
            ...
            <div className="flex h-full overflow-hidden">
              {/* Chat panel - basic flex */}
              <div className="flex-1 overflow-hidden border-r">
                {contextKey ? <MessageThreadFull contextKey={contextKey} /> : null}
              </div>

              {/* Editor panel - basic flex */}
              <div className="w-full md:w-[60%] overflow-auto relative">
                {mode === 'spreadsheet' ? (
                  <>
                ...
                {/* Component Stash Panel */}
                <ComponentStashPanel 
                  onUseComponent={(component) => {
                    // Register component dynamically when used
                    console.log('Using stashed component:', component);
                  }}
                />
              </div>
            </div>
